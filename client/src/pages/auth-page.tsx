...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      {/* Hero Section */}
      <div className="flex-1 bg-gradient-to-r from-primary/10 to-primary/20 flex flex-col justify-center p-12 hidden md:flex">
        <div className="max-w-md space-y-6">
          <h1 className="text-4xl font-bold tracking-tight">
            Discover and review your favorite stores
          </h1>
          <p className="text-lg">
            Join our platform to find, rate, and review stores in your area. 
            Help others make informed decisions with your valuable feedback.
          </p>
